...
exercise_05_03_framebuffers_sharpen := types.Tableau {
	init = proc() {
		shaders.init_shaders(.TransformTexture, .Sharpen)
	...
	draw = proc() {
		...
		sharpen_shader := shaders.shaders[.Sharpen]
