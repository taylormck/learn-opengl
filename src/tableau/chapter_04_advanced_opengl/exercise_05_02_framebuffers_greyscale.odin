...
exercise_05_02_framebuffers_greyscale :: types.Tableau {
	init = proc() {
		shaders.init_shaders(.TransformTexture, .Greyscale)
	...
	draw = proc() {
		...
		greyscale_shader := shaders.shaders[.Greyscale]
		...
		gl.UseProgram(greyscale_shader)
